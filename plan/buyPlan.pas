...
begin
  //2024.05.07 wk 药库库存
   ...
   dm.InitGrid(1,'MedStore_BuyPlan.xml',cxGrd_viewplan);
...
begin
  ...
  begin
    ...
    MYMedStore.ExportXLS('Q_Result',Q_Result,dt_datefrom.date,dt_dateto.Date,aTemplateName);
  end  else
  begin
...
begin
  ...
  //---
  self.Caption:=dm.sysinfo.hospitalName+'-'+'采购计划';
end;
