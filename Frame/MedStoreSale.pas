...
begin
  ...
  4:begin
      dm.InitGrid(1,'MedStore_SaleDept.xml',Frame_base1.cxgrdbtblvw);
      Frame_base1.FTemplateName:='科室汇总';
      MYMedStore.SearchMedStoreSaledept(Frame_base1.Q_Result,ayfbm,aPatientClass,Frame_base1.rg1.itemindex,adatefrom,adateto);
  end;
  end;
end;
