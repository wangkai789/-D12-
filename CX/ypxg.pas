...
uses
  ...
  cxGridBandedTableView, cxGridDBBandedTableView, cxDropDownEdit,MemDS,
  DBAccess, Uni, ComCtrls, cxLookAndFeels, cxLookAndFeelPainters, dxSkinsCore,
...
type
  TFm_ypchange = class(TForm)
   ...
   // FlexCelReport1: TFlexCelReport;
    ...
    procedure btn_serachClick(Sender: TObject);
    ...
    procedure cxgrdbtblvwStylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
      var AStyle: TcxStyle);
    procedure Edt_pymChange(Sender: TObject);
  private
...
procedure TFm_ypchange.btn_serachClick(Sender: TObject);
...
procedure TFm_ypchange.Edt_pymChange(Sender: TObject);
begin
  btn_serach.Click;
end;
...
begin
  Edt_pym.SetFocus;
  self.Caption:=dm.sysinfo.hospitalName+'-'+'药品维护';
end;
...
begin
  MYMedStore:=TMedStore.Create;
  MYMedStore.ExportXLS('Q_Result',Q_Result,date(),date(),'药品目录',1);
end;
